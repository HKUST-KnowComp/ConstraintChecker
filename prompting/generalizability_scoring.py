...
def parse():
  ...
  parser.add_argument('--q0', type=str, required=False,
    default='atomic_gpt3.5-turbo_naive_prompt3.txt')
  parser.add_argument('--q1', type=str, required=False,
    default='atomic_gpt3.5-turbo_moe_q1_prompt1.txt')
  parser.add_argument('--q3', type=str, required=False,
    default='atomic_gpt3.5-turbo_moe_q3_prompt3.txt')
  args = parser.parse_args()

  args.base_path = 'results/generalizability/'
  args.data_file = 'prompting_data/test_downsample_with_negative_sampling.csv'
...
python prompting/generalizability_scoring.py \
  --q0 atomic_gpt3.5-turbo_randomcot_prompt3.txt

python prompting/generalizability_scoring.py \
  --q0 atomic_davinci_naive_prompt3.txt
